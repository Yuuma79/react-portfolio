...
const introdata = {
    title: "I’m Christina Dao",
    animated: {
        first: "I am a Graphic Designer",
        second: "I create Branding Identity",
        third: "I do UX Design",
    },
    description: "A designer that's all about solving problems and making sure products are accessible to everyone.",
    your_img_url: "https://images.unsplash.com/photo-1626785774573-4b799315345d",
};

const dataabout = {
    title: "abit about my self",
    aboutme: "I am a Graphic Designer interested in UX and Branding Identity. I solve problems and communicate stories.",
};
const worktimeline = [{
...
const services = [{
    ...
    },
    {
        ...
        description: "Help clients create a brand identity for their company that will be used in widespread products.",
    },
    {
        title: "Graphic Design",
        description: "Using design to communicate a story to an audience.",
    },
];
